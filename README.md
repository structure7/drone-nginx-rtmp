...
* Download nginx code: `wget http://nginx.org/download/nginx-1.16.0.tar.gz` (Protip: Check [here](http://nginx.org/en/download.html) for the current nginx version.
...
`tar -zxvf nginx-1.16.0.tar.gz`<br>
`unzip master.zip`<br>
`cd nginx-1.16.0` 
* Build nginx:<br>
